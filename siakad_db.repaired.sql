...
--
-- Host: localhost:3306
-- Generation Time: Jul 04, 2026 at 09:56 AM
...
CREATE TABLE `audit_logs` (
  `id` int NOT NULL,
  `actor_id` int NOT NULL COMMENT 'user_id yang melakukan perubahan',
  `target_id` int NOT NULL COMMENT 'user_id yang datanya diubah',
  `action` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'update | delete | create | bulk_update | bulk_delete',
...
--
-- Table structure for table `evaluasi_jawaban`
--
...
--
-- Table structure for table `evaluasi_pertanyaan`
--
...
INSERT INTO `events` (`id`, `judul`, `level`, `tanggal_mulai`, `tanggal_selesai`, `lokasi`, `deskripsi`, `status`, `pic_id`, `template_dari_event_id`, `wa_group_link`, `swot_sent_at`, `link_dokumentasi`, `created_at`, `updated_at`, `is_template`, `template_notes`) VALUES
(20, 'Graduation', 'SMP', '2026-06-20', '2026-06-20', 'Aula Bambu', '-', 'draft', 36, NULL, NULL, NULL, NULL, '2026-06-15 02:05:27', '2026-06-15 02:05:27', 0, NULL),
(21, 'OTFA', 'SD', '2026-06-23', '2026-06-25', 'Gunung Everest', '-', 'draft', 1, NULL, NULL, NULL, NULL, '2026-06-18 06:26:45', '2026-06-18 06:26:45', 0, NULL);
...
--
-- Table structure for table `event_evaluasi`
--
...
INSERT INTO `event_files` (`id`, `event_id`, `nama_file`, `deskripsi`, `file_path`, `file_original`, `file_type`, `file_size`, `visibility`, `can_edit_by`, `uploaded_by`, `created_at`, `updated_at`) VALUES
(12, 20, 'Proposal', 'RAB fix', 'events/20/1781489892_9a5bfe2e.docx', 'Opal_Project_dengan_SS.docx', 'proposal', 1118006, 'pic_only', 'pic_only', 36, '2026-06-15 02:18:12', '2026-06-15 02:18:12'),
(13, 20, 'Rundown', 'Rundown', 'events/20/1781489937_217067a8.docx', 'Opal_Project.docx', 'rundown', 10624, 'all', 'pic_only', 36, '2026-06-15 02:18:57', '2026-06-15 02:18:57'),
(14, 21, 'Proposal Fix', '-', 'events/21/1781764095_e07f274b.pdf', 'Sertifikat Fundamental Jaringan Komputer - Catur Achmad Widiyanto - JXphJmBFnv.pdf', 'proposal', 118023, 'pic_only', 'inti', 1, '2026-06-18 06:28:16', '2026-06-18 06:28:16');
...
INSERT INTO `event_panitia` (`id`, `event_id`, `user_id`, `peran_acara`, `bagian`, `is_event_admin`, `is_double_job`, `status_konfirmasi`, `token_konfirmasi`, `token_expires_at`, `confirmed_at`, `catatan`, `created_at`) VALUES
(94, 20, 36, 'pic', NULL, 1, 0, 'bersedia', NULL, NULL, NULL, NULL, '2026-06-15 02:05:27'),
(95, 20, 28, 'panitia_inti', 'Kehumasan/Publikasi', 0, 1, 'bersedia', NULL, NULL, NULL, NULL, '2026-06-15 02:05:27'),
(96, 20, 29, 'panitia_inti', 'Sekretaris Acara', 0, 0, 'bersedia', NULL, NULL, NULL, NULL, '2026-06-15 02:05:27'),
(98, 21, 1, 'pic', NULL, 1, 0, 'bersedia', NULL, NULL, NULL, NULL, '2026-06-18 06:26:45'),
(99, 21, 28, 'panitia_inti', 'Kehumasan/Publikasi', 0, 1, 'bersedia', NULL, NULL, NULL, NULL, '2026-06-18 06:26:45'),
(100, 21, 29, 'panitia_inti', 'Sekretaris Acara', 0, 0, 'bersedia', NULL, NULL, NULL, NULL, '2026-06-18 06:26:45');

-- --------------------------------------------------------

--
-- Table structure for table `event_swot`
--
...
--
-- Table structure for table `event_swot_answers`
--
...
--
-- Table structure for table `event_swot_questions`
--
...
CREATE TABLE `login_attempts` (
  `id` int NOT NULL,
  `identifier` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'IP|email',
...
INSERT INTO `login_attempts` (`id`, `identifier`, `success`, `ip_address`, `created_at`) VALUES
(6, '::1|admin@sekolah.sch.id', 1, '::1', '2026-07-04 02:55:05');
...
INSERT INTO `notifications` (`id`, `user_id`, `judul`, `pesan`, `link`, `is_read`, `tipe`, `created_at`) VALUES
(41, 1, 'Form Evaluasi Tersedia', 'Form evaluasi acara Kurban sudah dibuka. Mohon isi sebelum 04 Jun 2026.', 'http://localhost/siakad/modules/evaluasi/fill.php?id=1', 1, 'info', '2026-06-04 07:14:15'),
(46, 1, 'Form Evaluasi Tersedia', 'Form evaluasi acara Kurban sudah dibuka. Mohon isi sebelum 04 Jun 2026.', 'http://localhost/siakad/modules/evaluasi/fill.php?id=2', 1, 'info', '2026-06-04 07:14:57'),
(54, 1, 'Form Evaluasi Tersedia', 'Form evaluasi acara Graduation sudah dibuka. Mohon isi sebelum 13 Jun 2026.', 'http://localhost/siakad/modules/evaluasi/fill.php?id=3', 1, 'info', '2026-06-09 04:04:32'),
(56, 1, 'Form Evaluasi Tersedia', 'Form evaluasi acara Graduation sudah dibuka. Mohon isi sebelum 13 Jun 2026.', 'http://localhost/siakad/modules/evaluasi/fill.php?id=4', 1, 'info', '2026-06-09 04:05:14'),
(59, 28, 'Undangan Panitia', 'Kamu diundang menjadi panitia acara Graduation', 'http://localhost/siakad/modules/events/workspace.php?id=18', 0, 'info', '2026-06-12 04:05:05'),
(60, 29, 'Undangan Panitia', 'Kamu diundang menjadi panitia acara Graduation', 'http://localhost/siakad/modules/events/workspace.php?id=18', 0, 'info', '2026-06-12 04:05:09');
...
--
-- Table structure for table `sdm_import_log`
--
...
--
-- Dumping data for table `sdm_import_log`
--

INSERT INTO `sdm_import_log` (`id`, `filename`, `total_rows`, `success_rows`, `skip_rows`, `imported_by`, `created_at`) VALUES
(1, 'Import Excel', 3, 3, 0, 1, '2026-05-13 01:28:47'),
(2, 'Import Excel', 8, 8, 0, 1, '2026-05-20 00:58:20'),
(3, 'Import Excel', 9, 9, 0, 1, '2026-05-20 01:00:44'),
(4, 'Import Excel', 9, 9, 0, 1, '2026-06-12 03:27:48'),
(5, 'Import Excel', 9, 9, 0, 1, '2026-06-15 02:03:02');
...
(3, 'school_name', 'Sekolah Alam Purwakarta', 'text', 'general', 'Nama Sekolah', 'Nama institusi', '2026-06-11 03:14:09'),
...
(28, 'Angger Hana Prakoso', 'ikhsannur8a@gmail.com', '$2y$10$TYUDT5PJptmS7XlEEnmUJ.v2bo8wQJsGJdjN5jOyVW42z5LG6eEqm', '', 'SMP', 'Fasil SM 3', 'staff', 'staff', 'aktif', '2026-06-12 03:27:48', '2026-06-15 02:03:01'),
(29, 'Ari Agus Setiawan', 'wiwid8a@gmail.com', '$2y$10$oFum/whyW.N1cAKjSn6LhedzvMDaghHmvTSxTJhhDs.O4DjEHnxau', '82345678901', 'TK', 'Fasil TK A', 'staff', 'staff', 'aktif', '2026-06-12 03:27:48', '2026-06-15 02:03:01'),
(30, 'Vina Melisa', 'vina@admin.sch.id', '$2y$10$ENR58YVytF1MaHzMExQKiuJCzssGLK.tFAiNSDXhVNzPOmcCnw9ca', '', 'SD', 'Manager SD', 'admin', 'staff', 'aktif', '2026-06-12 03:27:48', '2026-06-15 02:03:02'),
(31, 'Henni', 'heni@admin.sch.id', '$2y$10$kFACWM8.hb4bDp.6DX64dO8mrA9RSODZGN4J8RGb306Phk9F8QNY6', '', 'TK', 'Manager TK', 'admin', 'staff', 'aktif', '2026-06-12 03:27:48', '2026-06-15 02:03:02'),
(32, 'Fitriani', 'fitri@admin.sch.id', '$2y$10$dpKwJvZZd7iQxIE79Igr.uuRJcEzXrTewniwxYo8K5j7sETj9dar6', '', 'SMP', 'Manager SMP', 'admin', 'staff', 'aktif', '2026-06-12 03:27:48', '2026-06-15 02:03:02'),
(33, 'Nasya', 'nasya@admin.sch.id', '$2y$10$N2DoxLRRvle60OW2GhMtQuzlgovccOSYK2fzc5hE23ZAWACfSKQsK', '', 'Keuangan', 'Manager Keuangan', 'superadmin', 'staff', 'aktif', '2026-06-12 03:27:48', '2026-06-15 02:03:02'),
(34, 'Faradilla', 'dila@admin.sch.id', '$2y$10$L4KBnDkAakr0f/gSMK5dMeY8UaBliokPXwqK36gnvpTT3y3KPAhoK', '', 'INKLUSI', 'Fasil Inklsi', 'staff', 'staff', 'aktif', '2026-06-15 02:03:01', '2026-06-15 02:03:01'),
(35, 'Diana', 'diana@admin.sch.id', '$2y$10$VNqqg646cp5cZmXi7aC8tOoByiSruUDs1gAy5a2afnHgXAaaHQ0cu', '', 'INKLUSI', 'Manager Inklusi', 'staff', 'staff', 'aktif', '2026-06-15 02:03:01', '2026-06-15 02:03:01'),
(36, 'Catur Achmad Widiyanto', 'basquias81@gmail.com', '$2y$10$lRQrpw6uqHouPnFxGsryUufZFyoGdkTDEY5WGmZlnu9KizzuK4gCy', '81234567890', 'SD', 'Fasil SD 3', 'staff', 'staff', 'aktif', '2026-06-15 02:03:01', '2026-06-15 02:03:01');
...
ALTER TABLE `audit_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_target` (`target_id`,`created_at`),
...
ALTER TABLE `login_attempts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_identifier_time` (`identifier`,`success`,`created_at`);
