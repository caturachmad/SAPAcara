...
_Generated: 2026-05-17T12:33:52.254Z_
...
Workspace `mcp.json` _(folder: siakad)_

- **/var/www/html/siakad/.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **/home/caturachmadw/.claude.json** — _File missing_
